...
@section('content')
    <main class="pt-44 pb-16">
      <div class="container relative">
        {{-- <div
          class="absolute -top-20 lg:-top-10 start-8"
          data-aos="fade-down"
          data-aos-duration="600"
          data-aos-delay="100"
        >
          <a href="#" class="underline text-xl">تابع كزائر</a>
          <p>استمتع بجزء من الاختبار مجانًا، ولا حاجة للتسجيل</p>
        </div> --}}
        <div
        ...
        >
            ...
            <div
                ...
                data-aos-delay="200"
            >
                <h1 class="text-3xl font-bold text-gray-800 mb-2">أنشئ حساب</h1>
            </div>
